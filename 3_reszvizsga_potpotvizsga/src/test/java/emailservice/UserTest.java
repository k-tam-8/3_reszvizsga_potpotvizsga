...
class UserTest {
    ...
    void getEmailTest() {
        User user = new User("johndoe@gmail.com");
        user.getEmailAddress(new Normal(new User("johndoe@gmail.com"), new User("janedoe@gmail.com"), "how are you", "How are you?"));
        assertEquals(1, user.getIncoming().size());
        assertEquals("how are you", user.getIncoming().get(0).getSubject());

        user.getEmailAddress(new Spam(new User("johndoe@gmail.com"), "spam mail", "You won 10000$"));
    ...
    void getEmailWithSpamFilterTest() {
        User user = new User("johndoe@gmail.com");
        user.spamFilterChange();
        IllegalStateException ise = assertThrows(IllegalStateException.class, () -> user.getEmailAddress(new Spam(new User("johndoe@gmail.com"), "spam mail", "You won 10000$")));
    ...
    void getIncomingTest(){
        User user = new User("johndoe@gmail.com");
        user.getEmailAddress(new Normal(new User("johndoe@gmail.com"), new User("janedoe@gmail.com"), "how are you", "How are you?"));
        user.getEmailAddress(new Normal(new User("johndoe@gmail.com"), new User("janedoe@gmail.com"), "ImporTant", "How are you?"));
        user.getEmailAddress(new Normal(new User("johndoe@gmail.com"), new User("janedoe@gmail.com"), "how are you", "How are you?"));
